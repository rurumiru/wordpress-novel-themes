...
function xin_ranking_metrics() {
	return array(
		...
		'views'    => __( 'По просмотрам', 'xi-novels' ),
		'chapters' => __( 'По числу глав', 'xi-novels' ),
	);
}
...
function xin_ranking_periods() {
	return array(
		'all'   => array( __( 'За всё время', 'xi-novels' ), 0 ),
		'month' => array( __( 'За месяц', 'xi-novels' ), 30 ),
		'week'  => array( __( 'За неделю', 'xi-novels' ), 7 ),
	);
}
