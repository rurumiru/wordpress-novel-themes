...
function xin_register_post_types() {
	register_post_type( 'novel', array(
		'labels'              => array(
			'name'               => __( 'Новеллы', 'xi-novels' ),
			'singular_name'      => __( 'Новелла', 'xi-novels' ),
			'add_new'            => __( 'Добавить', 'xi-novels' ),
			'add_new_item'       => __( 'Добавить новеллу', 'xi-novels' ),
			'edit_item'          => __( 'Редактировать новеллу', 'xi-novels' ),
			'new_item'           => __( 'Новая новелла', 'xi-novels' ),
			'view_item'          => __( 'Смотреть новеллу', 'xi-novels' ),
			'search_items'       => __( 'Искать новеллы', 'xi-novels' ),
			'not_found'          => __( 'Новелл не найдено', 'xi-novels' ),
			'all_items'          => __( 'Все новеллы', 'xi-novels' ),
			'menu_name'          => __( 'Новеллы', 'xi-novels' ),
			'featured_image'     => __( 'Обложка', 'xi-novels' ),
			'set_featured_image' => __( 'Задать обложку', 'xi-novels' ),
		),
		'public'              => true,
		'has_archive'         => 'novels',
	...
	register_post_type( 'chapter', array(
		'labels'          => array(
			'name'          => __( 'Главы', 'xi-novels' ),
			'singular_name' => __( 'Глава', 'xi-novels' ),
			'add_new_item'  => __( 'Добавить главу', 'xi-novels' ),
			'edit_item'     => __( 'Редактировать главу', 'xi-novels' ),
			'all_items'     => __( 'Все главы', 'xi-novels' ),
			'search_items'  => __( 'Искать главы', 'xi-novels' ),
			'not_found'     => __( 'Глав не найдено', 'xi-novels' ),
			'menu_name'     => __( 'Главы', 'xi-novels' ),
		),
		'public'          => true,
		'has_archive'     => 'updates',
...
function xin_register_taxonomies() {
	register_taxonomy( 'genre', array( 'novel' ), array(
		'labels'            => array(
			'name'          => __( 'Жанры', 'xi-novels' ),
			'singular_name' => __( 'Жанр', 'xi-novels' ),
			'add_new_item'  => __( 'Добавить жанр', 'xi-novels' ),
			'menu_name'     => __( 'Жанры', 'xi-novels' ),
		),
		'hierarchical'      => true,
		'public'            => true,
	...
	register_taxonomy( 'novel_tag', array( 'novel' ), array(
		'labels'            => array(
			'name'          => __( 'Теги тайтлов', 'xi-novels' ),
			'singular_name' => __( 'Тег', 'xi-novels' ),
			'menu_name'     => __( 'Теги тайтлов', 'xi-novels' ),
		),
		'hierarchical'      => false,
		'public'            => true,
		'show_admin_column' => true,
	...
	register_taxonomy( 'novel_status', array( 'novel' ), array(
		'labels'            => array(
			'name'          => __( 'Статусы', 'xi-novels' ),
			'singular_name' => __( 'Статус', 'xi-novels' ),
			'menu_name'     => __( 'Статусы', 'xi-novels' ),
		),
		'hierarchical'      => true,
		'public'            => true,
		'show_admin_column' => true,
...
function xin_seed_terms() {
	...
	$statuses = array(
		'ongoing'   => __( 'Выходит', 'xi-novels' ),
		'completed' => __( 'Завершён', 'xi-novels' ),
		'hiatus'    => __( 'Заморожен', 'xi-novels' ),
		'announced' => __( 'Анонс', 'xi-novels' ),
	);
...
function xin_clear_chapter_cache( $post_id ) {
	if ( 'chapter' === get_post_type( $post_id ) ) {
		wp_cache_flush_group( 'xi-novels' );
	}
}
