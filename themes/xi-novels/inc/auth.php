...
function xin_auth_notice() {
	...
	$map = array(
		'credentials' => array( 'err', __( 'Не подходит: проверьте имя пользователя и пароль.', 'xi-novels' ) ),
		'empty'       => array( 'err', __( 'Заполните оба поля.', 'xi-novels' ) ),
		'expired'     => array( 'err', __( 'Форма была открыта слишком долго. Обновите страницу и отправьте снова.', 'xi-novels' ) ),
		'throttled'   => array( 'err', __( 'Слишком много попыток подряд. Подождите четверть часа.', 'xi-novels' ) ),
		'failed'      => array( 'err', __( 'Не получилось. Попробуйте ещё раз.', 'xi-novels' ) ),
		'closed'      => array( 'err', __( 'Регистрация сейчас закрыта.', 'xi-novels' ) ),
		'bad-name'    => array( 'err', __( 'Имя пользователя: от трёх символов, латиница, цифры, дефис и подчёркивание.', 'xi-novels' ) ),
		'name-taken'  => array( 'err', __( 'Такое имя уже занято.', 'xi-novels' ) ),
		'bad-email'   => array( 'err', __( 'Проверьте адрес почты.', 'xi-novels' ) ),
		'email-taken' => array( 'err', __( 'На эту почту аккаунт уже заведён. Войдите или восстановите пароль.', 'xi-novels' ) ),
		'short-pass'  => array( 'err', __( 'Пароль короче восьми символов.', 'xi-novels' ) ),
		'mismatch'    => array( 'err', __( 'Пароли не совпали.', 'xi-novels' ) ),
		'lost-sent'   => array( 'ok', __( 'Письмо со ссылкой на смену пароля отправлено.', 'xi-novels' ) ),
		'lost-failed' => array( 'err', __( 'Такой пользователь не найден.', 'xi-novels' ) ),
		'signed-out'  => array( 'ok', __( 'Вы вышли из аккаунта.', 'xi-novels' ) ),
	);
