...
$xin_links = array(
	array( 'icon' => 'compass', 'label' => __( 'Каталог', 'xi-novels' ), 'href' => get_post_type_archive_link( 'novel' ) ),
	array( 'icon' => 'clock', 'label' => __( 'Обновления', 'xi-novels' ), 'href' => get_post_type_archive_link( 'chapter' ) ),
	array( 'icon' => 'pen', 'label' => __( 'Стать автором', 'xi-novels' ), 'href' => xin_page_url( 'become-author' ) ),
	...
	<div class="xin-aurora">
		<div class="xin-wrap">
			<header class="xin-pagehead">
				<?php xin_breadcrumbs(); ?>
				<span class="xin-eyebrow"><?php esc_html_e( 'справка', 'xi-novels' ); ?></span>
				<h1><?php the_title(); ?></h1>
				<?php if ( has_excerpt() ) : ?>
		...
		<div class="xin-layout xin-layout--sidebar xin-mt-2">
			<article class="xin-panel xin-content xin-info">
				...
				<?php if ( ! get_the_content() ) : ?>
					<p class="xin-muted"><?php esc_html_e( 'Наполните эту страницу в админке: правила площадки, ответы на вопросы, контакты, политика — всё, что читателю нужно знать.', 'xi-novels' ); ?></p>
				<?php endif; ?>

				<p class="xin-info__updated xin-muted">
					<?php
					printf(
						esc_html__( 'Обновлено %s', 'xi-novels' ),
			...
			<aside class="xin-sidebar">
				<?php if ( count( $xin_pages ) > 1 ) : ?>
					<div class="widget">
						<h2 class="widget-title"><?php esc_html_e( 'Разделы справки', 'xi-novels' ); ?></h2>
						<ul>
				...
				<div class="widget">
					<h2 class="widget-title"><?php esc_html_e( 'Куда дальше', 'xi-novels' ); ?></h2>
				...
				if ( $xin_social ) :
					?>
					<div class="widget">
						<h2 class="widget-title"><?php esc_html_e( 'Связаться', 'xi-novels' ); ?></h2>
