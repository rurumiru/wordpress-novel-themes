...
<div class="xin-wrap">
	<header class="xin-pagehead">
		<?php xin_breadcrumbs(); ?>
		<h1><?php printf( esc_html__( 'Поиск: %s', 'xi-novels' ), esc_html( get_search_query() ) ); ?></h1>
		<p class="xin-pagehead__sub">
			<?php
			printf(
				esc_html( xin_plural( $wp_query->found_posts, __( 'Найден %s результат', 'xi-novels' ), __( 'Найдено %s результата', 'xi-novels' ), __( 'Найдено %s результатов', 'xi-novels' ) ) ),
...
$xin_novels   = array();
		...
		<?php if ( $xin_novels ) : ?>
			<section class="xin-section">
				<?php xin_section_head( array( 'title' => __( 'Тайтлы', 'xi-novels' ), 'icon' => 'book' ) ); ?>
		...
		<?php if ( $xin_chapters ) : ?>
			<section class="xin-section">
				<?php xin_section_head( array( 'title' => __( 'Главы', 'xi-novels' ), 'icon' => 'list' ) ); ?>
		...
		<?php if ( $xin_posts ) : ?>
			<section class="xin-section">
				<?php xin_section_head( array( 'title' => __( 'Статьи', 'xi-novels' ), 'icon' => 'newspaper' ) ); ?>
				<div class="xin-grid xin-grid--3">
