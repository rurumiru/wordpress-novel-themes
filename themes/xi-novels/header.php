		...
		<nav class="collapse navbar-collapse d-none d-lg-flex" aria-label="<?php esc_attr_e( 'Основная навигация', 'xi-novels' ); ?>">
			...
			if ( has_nav_menu( 'primary' ) ) {
				...
				<ul class="navbar-nav">
					...
					<?php if ( $xin_hub_page ) : ?>
						<li class="nav-item"><a class="nav-link<?php echo $xin_here['hub'] ? ' is-current' : ''; ?>"<?php echo $xin_here['hub'] ? ' aria-current="page"' : ''; ?> href="<?php echo esc_url( get_permalink( $xin_hub_page ) ); ?>"><?php esc_html_e( 'Уголок читателя', 'xi-novels' ); ?></a></li>
					<?php endif; ?>
	...
	<div class="offcanvas-body">
		...
		if ( has_nav_menu( 'primary' ) ) {
			...
			<ul class="xin-menu-list">
				...
				<?php if ( $xin_hub_side ) : ?>
					<li><a href="<?php echo esc_url( get_permalink( $xin_hub_side ) ); ?>"><?php esc_html_e( 'Уголок читателя', 'xi-novels' ); ?></a></li>
				<?php endif; ?>
			</ul>
			<?php
		}
