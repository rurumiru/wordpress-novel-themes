			...
			<?php foreach ( $xin_ids as $xin_i => $xin_id ) : ?>
				...
				<div class="xin-hero__slide" data-xin-hero-slide="<?php echo (int) $xin_i; ?>" <?php echo 0 === $xin_i ? '' : 'hidden'; ?>>
					<div class="xin-hero__eyebrow">
						...
						<?php echo esc_html( get_theme_mod( 'xin_hero_eyebrow', __( 'Сейчас в тренде', 'xi-novels' ) ) ); ?>
					</div>

					<h1 class="xin-hero__title"><?php echo esc_html( get_the_title( $xin_id ) ); ?></h1>
					<p class="xin-hero__author"><?php printf( esc_html__( 'от %s', 'xi-novels' ), esc_html( xin_novel_author( $xin_id ) ) ); ?></p>
					...
					<div class="xin-hero__meta">
						...
						<?php endif; ?>
						<span><?php xin_the_icon( 'book-open' ); ?><?php echo (int) xin_chapter_count( $xin_id ); ?> <?php echo esc_html( xin_plural( xin_chapter_count( $xin_id ), __( 'глава', 'xi-novels' ), __( 'главы', 'xi-novels' ), __( 'глав', 'xi-novels' ) ) ); ?></span>
					...
					<div class="xin-hero__actions">
						...
						<a class="btn btn-outline btn-lg" href="<?php echo esc_url( get_permalink( $xin_id ) ); ?>">
							<?php esc_html_e( 'Подробнее', 'xi-novels' ); ?><?php xin_the_icon( 'chevron-right' ); ?>
						</a>
					</div>
				</div>
			<?php endforeach; ?>
