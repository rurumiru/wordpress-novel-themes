...
<section class="xin-wrap xin-section">
	...
	xin_section_head( array(
		'eyebrow'  => __( 'в тренде', 'xi-novels' ),
		'title'    => __( 'Читатели не могут оторваться', 'xi-novels' ),
		'subtitle' => __( 'Тайтлы, набравшие больше всего внимания', 'xi-novels' ),
		'icon'     => 'trending',
	) );
	?>
					...
					<div>
						...
						<div class="xin-mt-2">
							<a class="btn btn-primary btn-sm" href="<?php echo esc_url( $xin_first ? get_permalink( $xin_first->ID ) : get_permalink( $xin_id ) ); ?>">
								<?php xin_the_icon( 'play' ); ?><?php esc_html_e( 'Начать читать', 'xi-novels' ); ?>
							</a>
						</div>
					</div>
				</div>
