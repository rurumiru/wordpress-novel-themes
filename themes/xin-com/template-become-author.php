...
$xin_perks = array(
	...
	array( 'icon' => 'crown', 'title' => __( 'Ранний доступ', 'xin-com' ), 'text' => __( 'Отмечайте главы как ранний доступ — в оглавлении они видны с замком и открываются позже или по покупке.', 'xin-com' ) ),
