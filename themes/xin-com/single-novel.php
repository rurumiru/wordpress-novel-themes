			...
			<div class="xin-wrap xin-nv__heroin">
				...
				<div class="xin-nv__intro">
					...
					<p class="xin-nv__numbers">
						<span><b><?php echo $xin_rating['count'] ? esc_html( number_format( $xin_rating['value'], 1, ',', '' ) ) : '—'; ?></b> <?php esc_html_e( 'оценка', 'xin-com' ); ?></span>
						<i></i>
						<span><b><?php echo (int) count( $xin_chapters ); ?></b> <?php esc_html_e( 'глав', 'xin-com' ); ?></span>
						<i></i>
					...
					<div class="xin-nv__cta">
						<?php if ( $xin_first ) : ?>
							<a class="btn btn-primary" href="<?php echo esc_url( get_permalink( $xin_first->ID ) ); ?>">
								<?php xin_the_icon( 'play' ); ?><?php esc_html_e( 'Читать с начала', 'xin-com' ); ?>
							</a>
						<?php endif; ?>
		...
		<div class="xin-wrap xin-nv__grid">
			...
			<div class="xin-nv__main">
				...
				<section class="xin-nv__sec">
					<div class="xin-nv__sechead">
						<h2><?php esc_html_e( 'Описание', 'xin-com' ); ?></h2>
					</div>
					...
					<button
						...
						data-more="<?php esc_attr_e( 'Читать полностью', 'xin-com' ); ?>"
						data-less="<?php esc_attr_e( 'Свернуть', 'xin-com' ); ?>"
					><?php esc_html_e( 'Читать полностью', 'xin-com' ); ?></button>
				...
				<section class="xin-nv__sec" id="chapters">
					<div class="xin-nv__sechead">
						<h2><?php esc_html_e( 'Оглавление', 'xin-com' ); ?></h2>
						<span class="xin-nv__count">
							<?php
							printf(
								esc_html( xin_plural( count( $xin_chapters ), __( '%d глава', 'xin-com' ), __( '%d главы', 'xin-com' ), __( '%d глав', 'xin-com' ) ) ),
					...
					<?php if ( $xin_chapters ) : ?>
						<div class="xin-nv__tools">
							<input type="search" placeholder="<?php esc_attr_e( 'Поиск по главам…', 'xin-com' ); ?>" data-xin-chapter-search aria-label="<?php esc_attr_e( 'Поиск по главам', 'xin-com' ); ?>">
							<button type="button" class="xin-nv__sort" data-xin-chapter-sort>
								<?php xin_the_icon( 'filter' ); ?><?php esc_html_e( 'Порядок', 'xin-com' ); ?>
							</button>
						</div>
							...
							<?php foreach ( $xin_chapters as $xin_chapter ) : ?>
								...
								<li data-xin-chapter-item>
									<a href="<?php echo esc_url( get_permalink( $xin_chapter->ID ) ); ?>">
										...
										<?php if ( $xin_locked ) : ?>
											<span class="xin-nv__lock" title="<?php esc_attr_e( 'Ранний доступ PLUS', 'xin-com' ); ?>"><?php xin_the_icon( 'lock' ); ?></span>
										<?php endif; ?>
						...
						<p class="xin-nv__empty" data-xin-chapter-empty hidden><?php esc_html_e( 'Ничего не найдено', 'xin-com' ); ?></p>
					<?php else : ?>
						<p class="xin-nv__empty"><?php esc_html_e( 'Главы ещё не опубликованы.', 'xin-com' ); ?></p>
					<?php endif; ?>
				</section>
			...
			<aside class="xin-nv__aside">
				...
				<section class="xin-nv__block">
					<h2><?php esc_html_e( 'О тайтле', 'xin-com' ); ?></h2>
				...
				<?php if ( $xin_team ) : ?>
					<section class="xin-nv__block">
						<h2><?php esc_html_e( 'Над проектом работают', 'xin-com' ); ?></h2>
				...
				<section class="xin-nv__block">
					<h2><?php esc_html_e( 'Ваша оценка', 'xin-com' ); ?></h2>
				...
				if ( ! is_wp_error( $xin_genres ) && $xin_genres ) :
					...
					if ( $xin_related ) :
						?>
						<section class="xin-nv__block">
							<h2><?php esc_html_e( 'Похожее', 'xin-com' ); ?></h2>
