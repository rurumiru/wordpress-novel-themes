...
<div class="xin-aurora">
	<div class="xin-wrap">
		<header class="xin-pagehead">
			<?php xin_breadcrumbs(); ?>
			<span class="xin-eyebrow"><?php esc_html_e( 'журнал', 'xin-com' ); ?></span>
			<h1><?php echo esc_html( get_the_title( get_option( 'page_for_posts' ) ) ?: __( 'Блог', 'xin-com' ) ); ?></h1>
...
<div class="xin-wrap xin-mt-2">
	...
	<?php if ( $xin_cats ) : ?>
		<div class="xin-catpills xin-mb-2">
			<a class="xin-catpill is-active" href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ); ?>"><?php esc_html_e( 'Все', 'xin-com' ); ?></a>
		...
		<article class="xin-blog-hero xin-reveal">
			...
			<div class="xin-blog-hero__body">
				...
				<div class="xin-blog-hero__meta">
					...
					<span>·</span>
					<span><?php echo esc_html( xin_num( xin_get_views( $xin_lead->ID ) ) ); ?> <?php esc_html_e( 'просмотров', 'xin-com' ); ?></span>
				</div>

				<p class="xin-mt-2">
					<a class="btn btn-primary" href="<?php echo esc_url( get_permalink( $xin_lead->ID ) ); ?>">
						<?php esc_html_e( 'Читать статью', 'xin-com' ); ?><?php xin_the_icon( 'chevron-right' ); ?>
					</a>
				</p>
			</div>
		</article>
