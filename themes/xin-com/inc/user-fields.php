...
function xin_user_fields() {
	return array(
		'xin_tagline'  => array( 'label' => __( 'Короткая подпись', 'xin-com' ), 'type' => 'text', 'hint' => __( 'Одна строка под именем: «переводчик с корейского», «пишу тёмное фэнтези».', 'xin-com' ) ),
		'xin_cover'    => array( 'label' => __( 'ID картинки-обложки профиля', 'xin-com' ), 'type' => 'number', 'hint' => __( 'Необязательно: ID файла из медиатеки. Пусто — рисуется градиент.', 'xin-com' ) ),
		...
		'xin_site'     => array( 'label' => __( 'Сайт', 'xin-com' ), 'type' => 'url', 'hint' => '' ),
		'xin_donate'   => array( 'label' => __( 'Ссылка на поддержку', 'xin-com' ), 'type' => 'url', 'hint' => __( 'Boosty, Patreon, кошелёк — показывается кнопкой в профиле.', 'xin-com' ) ),
	);
}

function xin_user_profile_fields( $user ) {
	?>
	<h2><?php esc_html_e( 'Профиль на площадке', 'xin-com' ); ?></h2>
