...
<div class="xin-wrap">
	<header class="xin-pagehead">
		<?php xin_breadcrumbs(); ?>
		<h1><?php esc_html_e( 'Моя библиотека', 'xin-com' ); ?></h1>
		<p class="xin-pagehead__sub"><?php esc_html_e( 'Закладки и история чтения хранятся в этом браузере — аккаунт не нужен.', 'xin-com' ); ?></p>
	</header>
	...
	<section class="xin-section">
		...
		<div class="xin-empty" data-xin-lib-empty hidden>
			...
			<h2><?php esc_html_e( 'Пока пусто', 'xin-com' ); ?></h2>
			<p><?php esc_html_e( 'Нажмите на закладку у любой обложки в каталоге — тайтл появится здесь.', 'xin-com' ); ?></p>
			<a class="btn btn-primary xin-mt-2" href="<?php echo esc_url( get_post_type_archive_link( 'novel' ) ); ?>">
				<?php xin_the_icon( 'compass' ); ?><?php esc_html_e( 'В каталог', 'xin-com' ); ?>
			</a>
		</div>
	</section>
