...
<div class="xin-rh">
	...
	<header class="xin-rh__top">
		<div class="xin-wrap">
			...
			<p class="xin-rh__kicker">
				...
				<?php esc_html_e( 'поток активен', 'xin-com' ); ?>
				<span>
					<?php
					/* translators: %s: current time. */
					printf( esc_html__( 'синхронизация %s', 'xin-com' ), esc_html( wp_date( 'H:i' ) ) );
					?>
				</span>
			</p>

			<h1 class="xin-rh__title" data-text="<?php the_title_attribute(); ?>"><?php the_title(); ?></h1>
			<p class="xin-rh__lede"><?php esc_html_e( 'Кто читает рядом, о чём спорят и что происходит на площадке прямо сейчас.', 'xin-com' ); ?></p>

			<dl class="xin-rh__ticker">
				<?php
				$xin_cells = array(
					array( __( 'Читателей', 'xin-com' ), xin_num( $xin_stats['readers'] ) ),
					array( __( 'Проектов', 'xin-com' ), number_format_i18n( $xin_stats['novels'] ) ),
					array( __( 'Глав', 'xin-com' ), xin_num( $xin_stats['chapters'] ) ),
					array( __( 'Комментариев', 'xin-com' ), xin_num( $xin_stats['comments'] ) ),
					array( __( 'Отметок', 'xin-com' ), xin_num( $xin_stats['reactions'] ) ),
					array( __( 'Новых за месяц', 'xin-com' ), number_format_i18n( $xin_stats['new_series'] ) ),
				);
	...
	<?php if ( $xin_high['series'] || $xin_high['author'] || $xin_high['contributor'] ) : ?>
		<div class="xin-wrap">
			<ul class="xin-rh__facts">
				<?php
				$xin_facts = array(
					array( __( 'Читают чаще всего', 'xin-com' ), $xin_high['series'] ),
					array( __( 'Пишет больше всех', 'xin-com' ), $xin_high['author'] ),
					array( __( 'Говорит больше всех', 'xin-com' ), $xin_high['contributor'] ),
				);
	...
	<section class="xin-rh__band">
		<div class="xin-wrap xin-rh__split">
			<div class="xin-rh__aside">
				...
				<h2 class="xin-rh__h"><?php esc_html_e( 'Кто говорит', 'xin-com' ); ?></h2>
				<p class="xin-rh__note"><?php esc_html_e( 'Семь человек, вокруг которых больше всего разговора. Шкала показывает долю от первого места.', 'xin-com' ); ?></p>
				<nav class="xin-rh__switch">
					<a class="<?php echo 'comments' === $xin_board_by ? 'is-on' : ''; ?>" href="<?php echo esc_url( add_query_arg( 'board', 'comments', $xin_base ) ); ?>"><?php esc_html_e( 'по комментариям', 'xin-com' ); ?></a>
					<a class="<?php echo 'reactions' === $xin_board_by ? 'is-on' : ''; ?>" href="<?php echo esc_url( add_query_arg( 'board', 'reactions', $xin_base ) ); ?>"><?php esc_html_e( 'по отметкам', 'xin-com' ); ?></a>
				</nav>
			</div>

			<div class="xin-rh__body">
				<?php if ( ! $xin_board ) : ?>
					<p class="xin-rh__empty"><?php esc_html_e( 'Обсуждений пока нет — самое время начать.', 'xin-com' ); ?></p>
				<?php else : ?>
								...
								<a class="xin-rh__person" href="<?php echo esc_url( $xin_row['url'] ); ?>">
									...
									<span class="xin-rh__who">
										...
										<small>
											...
											printf( esc_html__( 'прочитано %s', 'xin-com' ), esc_html( xin_num( $xin_row['read'] ) ) );
											?>
										</small>
									</span>
								</a>
	...
	<section class="xin-rh__band">
		<div class="xin-wrap xin-rh__split">
			<div class="xin-rh__aside">
				...
				<h2 class="xin-rh__h"><?php esc_html_e( 'О чём спорят', 'xin-com' ); ?></h2>
				<p class="xin-rh__note"><?php esc_html_e( 'Главы, набравшие больше всего разговора за две недели.', 'xin-com' ); ?></p>
			</div>

			<div class="xin-rh__body">
				<?php if ( ! $xin_trending ) : ?>
					<p class="xin-rh__empty"><?php esc_html_e( 'За две недели никто ничего не обсуждал.', 'xin-com' ); ?></p>
				<?php else : ?>
								...
								<a href="<?php echo esc_url( $xin_t['url'] ); ?>">
									...
									<span class="xin-rh__what">
										...
										<small>
											...
											printf( esc_html__( 'глава %1$s · %2$s', 'xin-com' ), esc_html( $xin_t['label'] ), esc_html( $xin_t['title'] ) );
											?>
										</small>
									...
									<span class="xin-rh__pair is-dim">
										...
										<small><?php esc_html_e( 'просмотров', 'xin-com' ); ?></small>
									</span>
								</a>
							</li>
						<?php endforeach; ?>
	...
	<section class="xin-rh__band">
		<div class="xin-wrap xin-rh__split">
			<div class="xin-rh__aside">
				...
				<h2 class="xin-rh__h"><?php esc_html_e( 'Сказано', 'xin-com' ); ?></h2>
				<p class="xin-rh__note"><?php esc_html_e( 'Реплики, которые собрали отклик. Длинные обрезаны.', 'xin-com' ); ?></p>
				<nav class="xin-rh__switch">
					<a class="<?php echo 'reacted' === $xin_talk_by ? 'is-on' : ''; ?>" href="<?php echo esc_url( add_query_arg( 'talk', 'reacted', $xin_base ) ); ?>"><?php esc_html_e( 'с отметками', 'xin-com' ); ?></a>
					<a class="<?php echo 'replied' === $xin_talk_by ? 'is-on' : ''; ?>" href="<?php echo esc_url( add_query_arg( 'talk', 'replied', $xin_base ) ); ?>"><?php esc_html_e( 'с ответами', 'xin-com' ); ?></a>
				</nav>
			</div>

			<div class="xin-rh__body">
				<?php if ( ! $xin_talk ) : ?>
					<p class="xin-rh__empty"><?php esc_html_e( 'Ни одного отмеченного комментария пока нет.', 'xin-com' ); ?></p>
				<?php else : ?>
							...
							<figure>
								...
								<p class="xin-rh__sig">
									<span>
										...
										<?php echo 'replied' === $xin_talk_by ? esc_html__( 'ответов', 'xin-com' ) : esc_html__( 'отметок', 'xin-com' ); ?>
									</span>
								</p>
							</figure>
						<?php endforeach; ?>
	...
	<section class="xin-rh__band xin-rh__band--last">
		<div class="xin-wrap xin-rh__split">
			<div class="xin-rh__aside">
				...
				<h2 class="xin-rh__h"><?php esc_html_e( 'Прямо сейчас', 'xin-com' ); ?></h2>

				<?php if ( $xin_me ) : ?>
					<div class="xin-rh__me">
						<p class="xin-rh__meh"><?php esc_html_e( 'ваш профиль', 'xin-com' ); ?></p>
						...
						<dl>
							<div>
								<dt>
									...
									printf( esc_html__( 'очков до уровня %s', 'xin-com' ), esc_html( number_format_i18n( $xin_me['level'] + 1 ) ) );
									?>
								</dt>
								<dd><?php echo esc_html( number_format_i18n( $xin_lv_left ) ); ?></dd>
							</div>
							<div><dt><?php esc_html_e( 'прочитано', 'xin-com' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $xin_me['read'] ) ); ?></dd></div>
							<div><dt><?php esc_html_e( 'дней подряд', 'xin-com' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $xin_me['streak'] ) ); ?></dd></div>
							<div><dt><?php esc_html_e( 'реплик', 'xin-com' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $xin_me['comments'] ) ); ?></dd></div>
							<div><dt><?php esc_html_e( 'отметок', 'xin-com' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $xin_me['reactions'] ) ); ?></dd></div>
						</dl>
					</div>
				<?php else : ?>
					<p class="xin-rh__note">
						...
						printf(
							...
							esc_html__( 'Свои цифры видны после того, как %s.', 'xin-com' ),
							'<a href="' . esc_url( xin_login_url( xin_current_url() ) ) . '">' . esc_html__( 'войдёте', 'xin-com' ) . '</a>'
						);
						?>
					</p>
				<?php endif; ?>
			...
			<div class="xin-rh__body">
				<?php if ( ! $xin_activity ) : ?>
					<p class="xin-rh__empty"><?php esc_html_e( 'Пока тихо. Как только кто-нибудь откроет главу, это появится здесь.', 'xin-com' ); ?></p>
				<?php else : ?>
							...
							<li>
								...
								<span>
									...
									printf(
										...
										esc_html__( 'читает «%1$s», глава %2$s', 'xin-com' ),
	...
	<p class="xin-wrap xin-rh__foot"><?php esc_html_e( 'Цифры обновляются раз в пять минут.', 'xin-com' ); ?></p>
</div>
