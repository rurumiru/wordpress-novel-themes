		...
		<?php if ( $xin_authors ) : ?>
			<div class="xin-panel">
				<div class="xin-panel__head">
					<h2><?php xin_the_icon( 'crown' ); ?><?php esc_html_e( 'Топ-авторы', 'xin-com' ); ?></h2>
					<a class="xin-head__more" href="<?php echo esc_url( get_post_type_archive_link( 'novel' ) ); ?>">
						<?php esc_html_e( 'Все', 'xin-com' ); ?><?php xin_the_icon( 'chevron-right' ); ?>
					</a>
				</div>
...
$xin_medal = $xin_i < 3 ? ' xin-badge--gold' : '';
						...
						<a class="xin-author-card" href="<?php echo esc_url( get_author_posts_url( $xin_author->ID ) ); ?>">
							...
							<span class="xin-author-card__count">
								<?php echo (int) $xin_count; ?> <?php echo esc_html( xin_plural( $xin_count, __( 'новелла', 'xin-com' ), __( 'новеллы', 'xin-com' ), __( 'новелл', 'xin-com' ) ) ); ?>
							</span>
						</a>
					<?php endforeach; ?>
				</div>
		...
		<?php if ( $xin_posts ) : ?>
			<div class="xin-panel">
				<div class="xin-panel__head">
					<h2><?php xin_the_icon( 'pen' ); ?><?php esc_html_e( 'Новости и статьи', 'xin-com' ); ?></h2>
