...
<form class="xin-panel" method="post" action="<?php echo esc_url( xin_dashboard_url() ); ?>" data-xin-chapter-editor="<?php echo (int) $xin_novel_id; ?>">
	...
	<div class="xin-panel__head">
		<h2>
			...
			<?php echo $xin_id ? esc_html__( 'Правка главы', 'xin-com' ) : esc_html__( 'Новая глава', 'xin-com' ); ?>
		</h2>
	...
	<div class="xin-form">
		<div class="xin-form__row xin-form__row--2">
			<div class="xin-field">
				<label for="xin-ch-title"><?php esc_html_e( 'Название главы', 'xin-com' ); ?></label>
			...
			<div class="xin-field">
				<label for="xin-ch-number"><?php esc_html_e( 'Номер', 'xin-com' ); ?></label>
				<input class="form-control" type="number" step="0.1" id="xin-ch-number" name="number" value="<?php echo esc_attr( $xin_number ); ?>">
				<p class="xin-field__hint"><?php esc_html_e( 'Дробный номер — экстра или интерлюдия: 12.5', 'xin-com' ); ?></p>
			</div>
		</div>
		...
		<div class="xin-flex xin-flex-wrap">
			<button type="submit" name="status" value="publish" class="btn btn-primary btn-lg">
				...
				<?php echo current_user_can( 'publish_posts' ) ? esc_html__( 'Опубликовать', 'xin-com' ) : esc_html__( 'Отправить на модерацию', 'xin-com' ); ?>
			</button>
			<button type="submit" name="and_new" value="1" class="btn btn-outline btn-lg">
				<?php esc_html_e( 'Опубликовать и начать следующую', 'xin-com' ); ?>
			</button>
