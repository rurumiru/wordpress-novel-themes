...
<div class="xin-panel">
	<div class="xin-panel__head">
		<h2><?php xin_the_icon( 'library' ); ?><?php esc_html_e( 'Мои проекты', 'xin-com' ); ?></h2>
	...
	<?php if ( ! $xin_novels ) : ?>
		<p class="xin-empty-inline"><?php esc_html_e( 'Проектов пока нет. Создайте первый — это займёт минуту.', 'xin-com' ); ?></p>
	<?php else : ?>
				...
				<article class="xin-work">
					...
					<div>
						...
						<div class="xin-work__meta">
							<span><?php echo (int) $xin_count; ?> <?php echo esc_html( xin_plural( $xin_count, __( 'глава', 'xin-com' ), __( 'главы', 'xin-com' ), __( 'глав', 'xin-com' ) ) ); ?></span>
							<span><?php echo esc_html( xin_num( xin_get_views( $xin_novel->ID ) ) ); ?> <?php esc_html_e( 'просмотров', 'xin-com' ); ?></span>
