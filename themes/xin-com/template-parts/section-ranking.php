...
$xin_tabs = array(
	'popular' => array( 'label' => __( 'По просмотрам', 'xin-com' ), 'ids' => isset( $args['popular'] ) ? $args['popular'] : array() ),
	'rated'   => array( 'label' => __( 'По оценке', 'xin-com' ), 'ids' => isset( $args['rated'] ) ? $args['rated'] : array() ),
	'updated' => array( 'label' => __( 'Свежие', 'xin-com' ), 'ids' => isset( $args['updated'] ) ? $args['updated'] : array() ),
);
