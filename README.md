...
![Version](https://img.shields.io/badge/version-beta%200.7.2-f59e0b?style=flat-square)
...
> [!NOTE]
> **Beta 0.7.2 — the platform works end to end.** You can install it today and publish titles and chapters. What is not final is the **presentation layer**: Bootstrap 5 is the current base, not the destination.
