...
![Versão](https://img.shields.io/badge/vers%C3%A3o-beta_0.7.0-f59e0b?style=flat-square)
...
> [!NOTE]
> **Beta 0.7.0 — a plataforma funciona de ponta a ponta.** Dá para instalar hoje e publicar obras e capítulos. O que ainda não está fechado é a **camada de apresentação**: o Bootstrap 5 é a base atual, não o destino.
