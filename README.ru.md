...
| 🌐 **Готова к переводу** | 453 строки, русский исходник и собранный английский `.mo`, плюс скрипт сборки |
...
Интерфейс идёт на **русском** (исходные строки) и **английском** (`languages/en_US.mo`, 453 строки). Посетитель переключает язык кнопкой RU / EN в шапке, выбор запоминается кукой.
