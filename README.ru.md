...
[![Версия](https://img.shields.io/badge/%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F-%D0%B1%D0%B5%D1%82%D0%B0%200.0.8-f59e0b)](CHANGELOG.md)
...
| 🌐 **Готова к переводу** | 608 строк, русский исходник и собранный английский `.mo`, плюс скрипт сборки |
...
Интерфейс идёт на **русском** (исходные строки) и **английском** (`languages/en_US.mo`, 608 строк). Посетитель переключает язык кнопкой RU / EN в шапке, выбор запоминается кукой.
