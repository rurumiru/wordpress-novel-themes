...
- **Пустая половина в блоке «Топ-авторы».** Два блока стояли в сетке, растягивающей каждый по высоте самого длинного, поэтому короткий список авторов оставлял рядом с новостями высокий пустой прямоугольник. Каждый блок держит свою высоту.
